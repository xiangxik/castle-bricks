package com.whenling.brick.base.entity;
...
@Entity
@Table(name = "tbl_user")
public class User extends DataEntity<Admin, Long> implements Lockedable, Disabledable, LogicDeleteable {

	private static final long serialVersionUID = -3389073939535714687L;
